...
export const RULES = {
  ...
  betaX: ['procyclicality_evidence'], m_rev: [], m_rate: [], lambda: [], rate0: [], rateGap: [],
...
export const RULE_TEXT = {
  ...
  feedback_evidence: 'Evidence about the feedback itself in a segment: how much revenue or funding a dollar of token spend returns and how much of it is re-spent on tokens (reinvestment rates, revenue per dollar of inference, funding raised against token-driven growth), or the observed growth rate of that segment’s token spend set against the implied steady growth listed under Calibration state. Cite both numbers; the gain moves toward the observation, down as well as up. Evidence that usage is large, or that a lab runs many agents, is about share or level (usage_share), not a loop gain.',
